 ...
 */
import type { PhysicsState, SpringConfig, SpringResult } from "../schemas/springSolverSchemas";
...
export function solveSpring(
  ...
  if (!Number.isFinite(current) || !Number.isFinite(target) || !Number.isFinite(velocity)) {
