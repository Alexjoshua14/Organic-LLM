...
export type OpenInChatLinkableId = keyof typeof providers;

export function getOpenInProviderHref(id: OpenInChatLinkableId, query: string): string {
  return providers[id].createUrl(query as never);
}

export function getOpenInProviderMeta(id: OpenInChatLinkableId) {
  return { icon: providers[id].icon, title: providers[id].title };
}
