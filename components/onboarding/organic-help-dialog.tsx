                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0 space-y-2">
                    ...
                    <p className="text-sm leading-relaxed text-muted-foreground">
                      ...
                      stay until you dismiss them and won&apos;t return on this browser once
                      dismissed. After four tips in a row, we pause so you can use the unobstructed
                      UI — use Show next tip when you&apos;re ready for more.
                    </p>
