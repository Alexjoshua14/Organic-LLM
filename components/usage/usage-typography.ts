...
/** Secondary metrics in breakdown rows (input, output, cached, rate) */
export const usageRowMetric = "text-2xs tabular-nums text-muted-foreground";

/** Model name in breakdown rows */
export const usageRowModel = "truncate text-xs text-foreground";
