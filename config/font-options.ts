...
const allFonts: FontOption[] = [
  ...
  { id: "open-sans", label: "Open Sans", googleId: "Open Sans", featured: false },
  { id: "roboto", label: "Roboto", googleId: "Roboto", featured: false },
  { id: "poppins", label: "Poppins", googleId: "Poppins", featured: false },
  { id: "work-sans", label: "Work Sans", googleId: "Work Sans", featured: false },
  { id: "rubik", label: "Rubik", googleId: "Rubik", featured: false },
  { id: "quicksand", label: "Quicksand", googleId: "Quicksand", featured: false },
  ...
  { id: "atkinson-hyperlegible", label: "Atkinson Hyperlegible", googleId: "Atkinson Hyperlegible", featured: false },
  { id: "ibm-plex-sans", label: "IBM Plex Sans", googleId: "IBM Plex Sans", featured: false },
  ...
  { id: "space-grotesk", label: "Space Grotesk", googleId: "Space Grotesk", featured: false },
  { id: "syne", label: "Syne", googleId: "Syne", featured: false },
  { id: "general-sans", label: "General Sans", googleId: "General Sans", featured: false },
  { id: "cabinet-grotesk", label: "Cabinet Grotesk", googleId: "Cabinet Grotesk", featured: false },
  { id: "instrument-sans", label: "Instrument Sans", googleId: "Instrument Sans", featured: false },
  { id: "switzer", label: "Switzer", googleId: "Switzer", featured: false },
  { id: "satoshi-google", label: "Satoshi (Google)", googleId: "Satoshi", featured: false },
  { id: "bricolage-grotesque", label: "Bricolage Grotesque", googleId: "Bricolage Grotesque", featured: false },
  { id: "archivo", label: "Archivo", googleId: "Archivo", featured: false },
  { id: "karla", label: "Karla", googleId: "Karla", featured: false },
  { id: "red-hat-display", label: "Red Hat Display", googleId: "Red Hat Display", featured: false },
  { id: "fira-sans", label: "Fira Sans", googleId: "Fira Sans", featured: false },
  { id: "albert-sans", label: "Albert Sans", googleId: "Albert Sans", featured: false },
  { id: "spline-sans", label: "Spline Sans", googleId: "Spline Sans", featured: false },
];
