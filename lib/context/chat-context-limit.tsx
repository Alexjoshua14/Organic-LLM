...
const default_warning_messages: Record<keyof ContextLimitWarning, string> = {
  ...
  medium: "You are approaching the context limit. Please consider summarizing your conversation or using a different model.",
 ...
 */
export const getContextLimit = ({ chatId }: getContextLimitProps): ContextLimitResult => {
...
const checkContext = ({ chatId, limit, used, remaining }: CheckContextProps): ContextLimitResult => {
