 ...
 * `link_memories` and `flag_*` are Phase 1 stubs until Supabase / Mem0 metadata linking ships.
 */
export function createDelphiMemoryTools(params: DelphiMemoryToolsParams): {
  tools: ToolSet;
  ...
  const toolInstructions = [
    ...
    "- link_memories / flag_for_followup / flag_for_review: currently return deferred=true until persistence lands.",
  ].join("\n");
