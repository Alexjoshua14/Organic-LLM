...
/** Compact highlight demos — shorter than default illustration frames. */
export const welcomeCompactHighlightIllustrationRatio = 2 / 1;

/** Chat mode cards (1/3 column) — portrait enough for a 4-row starter prompt list. */
export const welcomeModeIllustrationRatio = 2 / 3;

/** Feature bento cards (Strata, etc.) — shorter than chat mode demos. */
export const welcomeFeatureIllustrationRatio = 4 / 3;
