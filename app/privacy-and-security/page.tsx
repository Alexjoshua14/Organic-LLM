...
export default function PrivacyAndSecurityPage() {
  ...
  return (
    <Page>
      ...
      >
        <div className={cn(PROSE_CLASS, "mx-auto max-w-2xl space-y-10 [&_a]:no-underline")}>
          <div className="space-y-2">
            <p className="text-2xl font-medium text-foreground">
              We take privacy and security seriously.
            </p>
            <p className="text-sm italic leading-tight text-muted-foreground">
              This page explains how Organic LLM handles your data, what we store, what we send to
              third-party services, and the choices you have.
            </p>
          </div>

          <nav
            aria-label="On this page"
            className="rounded-lg border border-border/50 bg-background-tertiary/25 px-4 py-3"
          >
          ...
          <section id="what-we-do">
            ...
            <div className="mx-auto mt-2 w-full max-w-384">
              <div className="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-4">
                ...
                />
                <PrivacyFeatureCard
                  title={<span className="font-mono text-foreground">[REDACTION]</span>}
          ...
          <section id="data-we-store">
            ...
            <p className="text-foreground">
              We store your threads and messages in our database. Message and summary content is
              protected with{" "}
              <TermWithDefinition
              ...
              />
              —you only see and modify your own conversations. We also store preferences and some
              session data in your browser (localStorage); that data stays on your device and is not
              sent to our servers except as part of normal requests (e.g. settings you choose).
            </p>
            <p className="mt-2 text-foreground">
              The Zero Data Retention setting applies to external LLM providers (so they do not
              retain your data). It does not change how long Organic LLM keeps your threads and
              messages in our own database; you can delete threads and use the options in Settings
              to control memory and retention. Organic LLM aims to provide you full control over
          ...
          <section id="third-parties">
            ...
            <p className="text-foreground">
              To provide chat, search, voice, and memory, we send certain data to trusted partners:
            </p>
            <ul className="list-inside list-disc space-y-1 text-foreground">
              <li>
                <strong>LLM providers</strong> (e.g. OpenAI, Anthropic): Your conversation context
                is sent so the model can respond. When Zero Data Retention is on, we request that
                they do not retain your data.
              </li>
              <li>
                <strong>Exa</strong>: Search queries (and optionally URLs) for web search and
                research features.
              </li>
              <li>
                <strong>ElevenLabs</strong>: Text you choose to convert to speech (TTS).
              </li>
              <li>
                <strong>Memory (Mem0 Platform)</strong>: When memory is enabled, we use Mem0
                Platform to store and retrieve conversation-based memory so the assistant can
                remember context across threads. We are moving toward Mem0 Platform for production
                use and are considering allowing users to host their own memory databases in the
                future; memory configuration may evolve.
              </li>
              <li>
            ...
            <div className="mt-2 space-y-4">
              <div>
                ...
                <p className="mt-1 text-foreground">
                  We use Clerk as our authentication provider. Clerk supports passkeys and
                  biometrics so you can sign in without passwords when you choose. All access to the
                  app is gated by your verified identity.
                </p>
              </div>
              <div>
                <h3 className="text-sm font-semibold text-foreground">Data access</h3>
                <p className="mt-1 text-foreground">
                  Access to your data is scoped by your identity. Our database enforces{" "}
                  <TermWithDefinition
                    term="RLS"
                    definition="Row Level Security; database policies that ensure each user can only read or write their own rows (e.g. their own threads and messages)."
                  />{" "}
                  so that you can only access your own threads, messages, and related data.
                </p>
              </div>
              <div>
                <h3 className="text-sm font-semibold text-foreground">Rate limiting</h3>
                <p className="mt-1 text-foreground">
                  We apply rate limits to protect against abuse and to keep the service stable for
                  everyone.
                </p>
              </div>
              <div>
                <h3 className="text-sm font-semibold text-foreground">Secure connections</h3>
                <p className="mt-1 text-foreground">
          ...
          <section id="your-choices">
            ...
            <p className="text-foreground">
              ...
              />{" "}
              so that external LLMs do not retain your data. You can also control whether we redact
              common{" "}
              <TermWithDefinition
              ...
              />{" "}
              before sending text to external services (default on). You can disable memory or
              delete threads to limit what is stored. Account deletion is not yet implemented in the
              app; to request deletion of your account and data, please contact us at{" "}
              <a
          ...
          <section id="encryption">
            ...
            <p className="text-foreground">
              Sensitive chat and summary content is encrypted before being stored in our database
              (application-layer encryption with AES-256-GCM). That means even with access to the
              database, your message content appears as ciphertext. Data in transit between you and
              our servers is protected with TLS. We do not use end-to-end encryption for the main
              chat flow (the server and LLM providers need to process plaintext to generate
              responses); the encryption we use protects your data at rest in our systems.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-foreground">
              When we use third-party logging or monitoring, we only send non-sensitive operational
              data—such as performance and usage metrics—not your conversation content, memories, or
              other private data.
            </p>
          </section>
          ...
          <section id="contact">
            ...
            <p className="text-foreground">
              For deletion requests, privacy questions, or security concerns, contact us at{" "}
              <a
                href="mailto:coalescencelabs@gmail.com"
                className="text-foreground hover:text-foreground/90"
              >
          ...
          <nav className="pt-4">
            <Link href="/settings" className="text-sm text-foreground hover:text-foreground/90">
              ← Back to Settings
            </Link>
          </nav>
        </div>
