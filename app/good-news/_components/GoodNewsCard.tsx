  ...
  return (
    ...
    >
      <div className="flex gap-4 md:gap-5">
        <div
          aria-hidden="true"
          className="shrink-0 select-none text-3xl font-semibold tabular-nums leading-none text-foreground/25 md:text-4xl"
        >
        ...
        <div className="min-w-0 flex-1">
          <div className="mb-2 flex flex-wrap items-center gap-2">
            <span
              className={cn("rounded-full px-2.5 py-0.5 text-xs font-medium", category.badgeClass)}
            >
              {category.label}
            </span>
            <span
              className="inline-flex items-center gap-1 rounded-full bg-emerald-500/10 px-2.5 py-0.5 text-xs font-medium text-emerald-700 dark:text-emerald-300"
          ...
          <p className="mt-1.5 text-sm leading-relaxed text-foreground/90">{item.summary}</p>
