...
import { GoodNewsEmpty } from "./_components/GoodNewsEmpty";
      ...
      <div className="mx-auto w-full max-w-2xl px-4 py-10 md:px-6 md:py-14">
        <header className="mb-8">
          ...
          <p className="mt-3 max-w-prose text-sm leading-relaxed text-muted-foreground">
            The top {hasItems ? digest!.items.length : 10} optimistic stories from the past week —
            advances in medicine and science, climate and conservation wins, peace, and human
            progress. Every item is cross-checked against multiple credible sources before it
            appears here.
          </p>
          {digestDateLabel ? (
        ...
        <main aria-label="Good news stories">
          {hasItems ? <GoodNewsList items={digest!.items} /> : <GoodNewsEmpty />}
        </main>
        ...
        <footer className="mt-10 border-t border-border/40 pt-5">
          <p className="text-xs leading-relaxed text-muted-foreground">
            ...
            supported by the underlying reporting. Speculation, forecasts, and opinion are excluded.
          </p>
        </footer>
      </div>
    </div>
