          ...
          >
            ...
            >
              ...
              >
                ...
                <span className="inline text-[10px] text-muted-foreground group-data-[state=open]:hidden">
                  Show
                </span>
                <span className="hidden text-[10px] text-muted-foreground group-data-[state=open]:inline">
                  Hide
                </span>
              </CollapsibleTrigger>
              <CollapsibleContent
              ...
              {data.runs?.length ? (
                <>
                  <p className="text-[10px] leading-snug text-muted-foreground">
                    ...
                    {" · "}
                    Legacy (left),{" "}
                    <span className="font-mono text-[10px]">{MEMORY_V2_COLLECTION}</span> (right).
