      ...
      <div className="h-full min-h-0 w-full overflow-y-auto pb-16">
        <PageContentFrame maxWidth="4xl">
          ...
          <Tabs className="w-full" defaultValue="primitives">
            ...
            <TabsContent
              className="mt-0 space-y-0 focus-visible:ring-offset-0"
              value="processing-proto"
            >
              <p className="mb-6 text-sm text-muted-foreground leading-relaxed">
                Instant assistant-row mount + character-level processing label transitions.
                Production Arcadia uses{" "}
                <code className="rounded bg-muted px-1 py-0.5 text-xs">ChatThinking</code> →{" "}
                <code className="rounded bg-muted px-1 py-0.5 text-xs">ProcessingTextBurn</code>;
                left column keeps legacy ShinyText for comparison.
              </p>
              <ProcessingTailDemo />
            </TabsContent>
              ...
              <div className="space-y-1">
                <StateBlock label="Tool in flight (inline row before result)">
                  <p className="mb-3 text-xs text-muted-foreground">
                    Bordered row with <code className="rounded bg-muted px-1">ChatThinking</code>{" "}
                    and a label from the tool name (same pattern for AI SDK v5 tool parts and legacy
                    tool-invocation).
                  </p>
